...
export const SAMPLE_DOCUMENTS: BillDocument[] = [
  ...
  },
  {
    ...
    type: 'bill',
    title: 'HOSPITAL BILL',
    billNumber: 'HSP-2026-1123',
    issueDate: '2026-09-06',
    dueDate: '2026-09-06',
    currency: 'INR',
    senderName: 'CityCare',
    senderTagline: 'Multispeciality Hospital',
    senderAddress: '101 abc villa',
    senderPhone: '+9177383873',
    senderEmail: 'ddd@gmail.com',
    senderWebsite: 'www.ggh.com',
    clientName: 'Walk-in Patient',
    patientId: '112233',
    patientGender: 'Male',
    patientAge: '32 Years',
    clientAddress: 'N/A',
    clientEmail: 'patient@gmail.com',
    items: [
    ...
    taxRate: 5,
    discount: 0,
    paymentNotes: 'Settled at hospital billing desk.',
    template: 'medical-clinical',
    accent: 'slate',
    status: 'Paid',
    createdAt: '2026-09-06T10:00:00.000Z',
  },
