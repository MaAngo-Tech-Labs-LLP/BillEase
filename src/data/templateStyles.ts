...
export const TEMPLATES: TemplateStyle[] = [
  ...
  },
  {
    ...
    docType: 'bill',
    badge: 'Retail Ready',
    description: 'Modern retail and wholesale store bill featuring dual store/customer outlet cards, POS transaction metadata, elegant lavender and slate purple theme, and barcode authentication.',
    tags: ['Retail', 'POS', 'Store', 'Counter Bill'],
    layoutType: 'receipt',
    accentColor: '#85749c',
    headerBg: '#85749c',
    headerText: '#FFFFFF',
    tableHeaderBg: '#eeeaf2',
    tableHeaderText: '#2e2b38',
    totalColor: '#85749c',
    borderColor: '#eae6ee',
    logoText: '',
    docLabel: 'RETAIL STORE & POS BILL',
    sampleClient: 'Walk-in Customer',
    sampleItems: [
      { desc: 'jj', qty: 2, rate: 5 },
      { desc: 'ddd', qty: 2, rate: 7 },
    ],
  },
  {
    id: 'medical-clinical',
    ...
    docType: 'bill',
    badge: 'Clinical',
    description: 'Hospital & Healthcare billing format featuring clinical cross emblem with ECG pulse, CityCare styling, elegant vertical summary sidebar, services & charges table, and dusty-rose & slate palette.',
    tags: ['Clinical', 'Hospital', 'Doctors', 'Medical', 'Healthcare'],
    layoutType: 'clinical',
    accentColor: '#b48e89',
    headerBg: '#4d5b63',
    headerText: '#FFFFFF',
    tableHeaderBg: '#4d5b63',
    tableHeaderText: '#FFFFFF',
    totalColor: '#4d5b63',
    borderColor: '#ede6e2',
    logoText: 'CityCare Multispeciality Hospital',
    docLabel: 'HOSPITAL BILL',
    sampleClient: 'Walk-in Patient',
    sampleItems: [
      { desc: 'General Consultation', qty: 1, rate: 500 },
      { desc: 'Blood Test (CBC)', qty: 1, rate: 1200 },
      { desc: 'Medicine', qty: 5, rate: 80 },
      { desc: 'Nursing Charges', qty: 1, rate: 300 },
    ],
  },
  {
    id: 'academia-blue',
